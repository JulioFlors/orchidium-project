...
async function analyzeSundayNoon() {
  console.log('\n======================================================')
  console.log('  ANÁLISIS DE TELEMETRÍA - DOMINGO 5 DE JULIO (Mediodía)')
  console.log('  Ventana: 11:30 AM → 04:30 PM (Caracas)')
  console.log('======================================================\n')

  // 5 Julio 11:30 AM Caracas = 15:30 UTC
  // 5 Julio 04:30 PM Caracas = 20:30 UTC
  const query = `
    SELECT time, temperature, humidity, illuminance
    FROM "environment_metrics"
    WHERE "zone" = 'EXTERIOR'
      AND time >= '2026-07-05T15:30:00Z'
