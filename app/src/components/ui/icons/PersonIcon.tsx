...
interface Props extends SVGProps<SVGSVGElement> {
  // Opcional: si quieres forzar un color específico,
  // aunque por defecto usará el color del texto (currentColor)
  fillColor?: string
}

export function PersonIcon({ fillColor, className, ...props }: Props) {
  return (
    <svg
      aria-hidden="true"
      className={className}
