...
export function TeslaValuesSection() {
  return (
    <section className="bg-surface dark:bg-canvas tds-xs:h-[calc(100dvh-56px)] relative flex h-[calc(100dvh-36px)] w-full snap-start flex-col justify-between overflow-hidden pt-24 pb-16">
