...
import { FormField, Button, SelectDropdown, Input } from '@/components/ui'
    ...
    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="space-y-4">
        ...
        {fields.map((field, index) => (
          <div
            key={field.id}
            className="border-divider bg-surface flex items-end gap-3 rounded-lg border p-4"
          >
            <div className="bg-action/10 text-action flex h-10 w-10 shrink-0 items-center justify-center rounded-full font-bold">
              {index + 1}
            </div>
